...
function crimson_theme_customizer( $wp_customize ) {
  ...
  $wp_customize->add_setting(
    'crimson_default_header_template',
    array(
      'default'    =>  'b12',
      'transport'  =>  'refresh'
    )
  ...
  $wp_customize->add_control( 'crimson_default_header_template', array(
      'type' => 'select',
      'section' => 'crimson_site_options',
      'settings' => 'crimson_default_header_template',
  ...
  $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'crimson_favicon', array(
        'settings'		=> 'crimson_favicon',
        'section'		=> 'crimson_site_options',
        'label'			=> 'Favicon',
  ...
  $wp_customize->add_control( 'crimson_sitemap_link', array(
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'crimson_site_credits_logo', array(
          'settings'		=> 'crimson_site_credits_logo',
          'section'		=> 'crimson_site_options',
          'label'			=> 'Site Credit Logo',
          'description'	=> 'Logo of the company or person who built the site',
          'active_callback' => 'crimson_is_site_credits_on'
        )
      )
    );

    $wp_customize->add_setting(
      'crimson_site_credits_link',
      array(
        'default'    =>  '',
        'transport'  =>  'refresh'
      )
    ...
    $wp_customize->add_control( 'crimson_site_credits_link', array(
        'type' => 'text',
        'section' => 'crimson_site_options',
        'settings' => 'crimson_site_credits_link',
